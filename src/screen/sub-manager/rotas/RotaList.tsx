      ...
      },
      {
        ...
        render: (rota: Rota) => (
          <div className="flex items-center justify-end gap-1">
            <button
              onClick={() => navigate(ROUTES.SUB_MANAGER.ROTAS.DETAILS(rota._id))}
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-3">
          ...
          <Button
            variant="primary"
            onClick={() => navigate(ROUTES.SUB_MANAGER.ROTAS.CREATE)}
                  ...
                  {!weekData ? (
                    ...
                    <WeeklyScheduleGrid
                      ...
                      onShiftClick={(shiftId) =>
                        navigate(ROUTES.SUB_MANAGER.ROTAS.DETAILS(shiftId))
                      }
                    />
                  )}
                </div>
